...
echo "🚀 Preparing dhiraj/php-file-manager for publication..."
...
echo "   git remote add origin https://github.com/dhirajdhiman/php-file-manager.git"
...
echo "   • Enter: https://github.com/dhirajdhiman/php-file-manager"
